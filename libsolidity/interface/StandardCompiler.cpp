...
)
{
	...
	if (_artifactRequested("functionDebugData"))
		output["functionDebugData"] = StandardCompiler::formatFunctionDebugInfo(_object.functionDebugInfo);
...
Json::Value StandardCompiler::formatFunctionDebugInfo(
	map<string, evmasm::LinkerObject::FunctionDebugInfo> const& _debugInfo
)
{
	Json::Value ret(Json::objectValue);
